  ...
  return (
    <div className="onboarding-complete">
      ...
      <div className="onboarding-complete__body">
        <img src={checkIcon} alt="" className="onboarding-complete__check" />
        <div className="onboarding-complete__text">
      ...
      {/* 추천 결과 이미지 3개 - API 연동 전 임시로 products prop 없으면 빈 카드만 표시 */}
